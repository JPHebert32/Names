...
url = "http://localhost:5000/api/v1.0/year/2018"
...
function init() {
    d3.json(yrMaleURL).then(function (maleData) {
        ...
        // var status  = yearsMaleData.getElementsByName("status")[0];
        // var jsonArr = [];
        ...
        //     });
        // }
//create the loop to go through the data of table on the webpage to display the names in the table.
        // var r;

        // for (r in maleData) {
        //     var my_object = {};
        //     my_object.key = [0];
        //     my_object.name = maleData.name;
        //     my_object.value = maleData.count;
        //     data.push(my_object);
        // }
...
// scales
    ...
    function brushmove() {
        ...
        var newMaxXScale = d3.max(data, function (d) { return selected.indexOf(d.name) > -1 ? d.value : 0; });
